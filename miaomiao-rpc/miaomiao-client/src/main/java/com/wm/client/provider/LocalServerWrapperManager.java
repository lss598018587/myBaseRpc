...
import com.wm.common.exception.rpc.RpcWrapperException;
...
import static com.wm.common.utils.Reflects.*;
...
public class LocalServerWrapperManager {
	...
	class DefaultServiceWrapper implements ServiceWrapperWorker {
		...
		private <M, T> T copyProviderProperties(M provider, T proxy) {
